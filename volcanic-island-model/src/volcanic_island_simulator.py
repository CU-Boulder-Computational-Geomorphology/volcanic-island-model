...
class VolcanicIslandSimulator:
    def __init__(self, params={}):
        ...
        if "diffusivity" in params:
           ...
           self.linear_diffusivity = diffusion_params["diffusivity"]
           self.soil_transport_decay_depth = diffusion_params["soil_decay"]
        ...
        if "weathering" in params:
            ...
            self.soil_production__maximum_rate = weathering_params["production_max"] 
            self.soil_production__decay_depth = weathering_params["production_decay"]
    ...
    def update(self, dt):
        ...
        self.DepthDependentDiffuser.run_one_step(dt)
        self.ExponentialWeatherer.run_one_step(dt)
